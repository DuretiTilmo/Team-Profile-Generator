  ...
  return inquirer.prompt([
    {
      ...
      validate: (value) => {
        if (value) {
          return true;
        } else return "Please enter team manager's name?";
      },
    },
    {
      type: "input",
    ...
    },
    {
      ...
      validate: (value) => {
        if (value) {
          return true;
        } else return "Please enter team manager's email?";
      },
    },
    {
      type: "input",
  ...
  return inquirer.prompt([
    ...
    },
    {
      ...
      validate: (value) => {
        if (value) {
          return true;
        } else return "Please enter the engineer's email?";
      },
    },
    {
      type: "input",
  ...
  return inquirer.prompt([
    {
      ...
      validate: (value) => {
        if (value) {
          return true;
        } else return "Please enter your intern's name?";
      },
    },
    {
      type: "input",
    ...
    },
    {
      ...
      validate: (value) => {
        if (value) {
          return true;
        } else return "Please enter your intern's email?";
      },
    },
    {
      type: "input",
